      ...
      <div className="mx-auto container px-6">
        <header className="mb-8 sm:mb-10">
          ...
          <p className="mt-2 text-cool_gray-600">
            Heb je een idee, project of vraag? Stuur me een bericht. Ik reageer meestal binnen 1–2 werkdagen.
          </p>
        </header>
        ...
        <div className="rounded-2xl border border-cool_gray-800/20 bg-ghost_white-900/70 p-6 shadow-soft backdrop-blur">
          <form action="#" method="post" noValidate aria-labelledby="contact-title" className="grid grid-cols-1 gap-5">
            ...
            <div>
              ...
              />
              <p id="naam-help" className="mt-1 text-xs text-cool_gray-600 dark:text-ghost_white-800/70">Hoe mag ik je aanspreken?</p>
            </div>

            <div>
              <label htmlFor="email" className="mb-1 block text-sm font-medium text-cool_gray-400 dark:text-ghost_white-800">E‑mail</label>
              <input
                id="email"
                name="email"
                type="email"
            ...
            <div>
              <label htmlFor="onderwerp" className="mb-1 block text-sm font-medium text-cool_gray-400 dark:text-ghost_white-800">Onderwerp</label>
              <input
                id="onderwerp"
                name="onderwerp"
                type="text"
            ...
            <div>
              <label htmlFor="bericht" className="mb-1 block text-sm font-medium text-cool_gray-400 dark:text-ghost_white-800">Bericht</label>
              <textarea
                id="bericht"
                name="bericht"
                required
              ...
              />
              <p className="mt-1 text-xs text-cool_gray-600 dark:text-ghost_white-800/70">Geen gevoelige informatie versturen via dit formulier.</p>
            </div>

            <div className="flex items-center justify-between gap-4">
              <div className="text-sm text-cool_gray-600 dark:text-ghost_white-800/80">
                Of mail direct: {" "}
