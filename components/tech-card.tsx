...
export default function TechCard({ name, logo }: TechCardProps) {
  return (
    ...
    >
      ...
      <figcaption className="mt-3 text-sm font-medium text-cool_gray-400 transition-colors duration-200 ease-out group-hover:text-cool_gray-300 dark:text-ghost_white-800">
        {name}
      </figcaption>
    </div>
  );
